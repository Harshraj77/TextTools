    ...
    <div className="container">
      <div className="card">
        ...
        <div className="card-body" style={{backgroundColor: props.mode==='light'?'white':'grey',color: props.mode==='dark'?'white':'black'}}>
          <h5 className="card-title text-center" style={{fontFamily: 'Cormorant SC', fontSize:'22px',backgroundColor: props.mode==='light'?'white':'grey',color: props.mode==='dark'?'white':'black'}}>TextTools</h5>
          <p className='card-body'   style={{fontFamily: 'Ibarra Real Nova', fontSize: '18px',backgroundColor: props.mode==='light'?'white':'grey',color: props.mode==='dark'?'white':'black'}}>
